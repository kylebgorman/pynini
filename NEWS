...
* Removes unused `containment` operator

v. 1.9 (compatible with OpenFst 1.6.6)
======================================

* Adds optional ability to disable symbol table attachment after string compilation
* The string_map and string_file functions now support one to three columns
